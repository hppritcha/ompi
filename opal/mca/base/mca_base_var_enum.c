...
static int mca_base_var_enum_bool_get_value(mca_base_var_enum_t *self, int index, int *value,
                                            const char **string_value)
{
    if (1 < index) {
...
static int mca_base_var_enum_auto_bool_get_value(mca_base_var_enum_t *self, int index, int *value,
                                                 const char **string_value)
{
...
static mca_base_var_enum_value_t verbose_values[] = {{MCA_BASE_VERBOSE_NONE, "none"},
...
int mca_base_var_enum_create(const char *name, const mca_base_var_enum_value_t *values,
...
int mca_base_var_enum_create_flag(const char *name, const mca_base_var_enum_value_flag_t *flags,
...
static int enum_value_from_string(mca_base_var_enum_t *self, const char *string_value,
                                  int *value_out)
{
...
static int enum_get_value_flag(mca_base_var_enum_t *self, int index, int *value,
                               const char **string_value)
{
...
static int enum_value_from_string_flag(mca_base_var_enum_t *self, const char *string_value,
                                       int *value_out)
{
    mca_base_var_enum_flag_t *flag_enum = (mca_base_var_enum_flag_t *) self;
...
static int enum_string_from_value_flag(mca_base_var_enum_t *self, const int value,
                                       char **string_value)
{
    mca_base_var_enum_flag_t *flag_enum = (mca_base_var_enum_flag_t *) self;
    ...
    for (int i = 0; i < count; ++i) {
        ...
        ret = opal_asprintf(&out, "%s%s%s", tmp ? tmp : "", tmp ? "," : "",
...
int mca_base_var_enum_register(const char *project_name, const char *framework_name,
                               const char *component_name, const char *enum_name, void *storage)
{
    int group_index;
    ...
    group_index = mca_base_var_group_register(project_name, framework_name, component_name, NULL);
    if (-1 > group_index) {
        return group_index;
    }
