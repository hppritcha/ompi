...
subroutine MPI_Rsend_init_f08(buf,count,datatype,dest,tag,comm,request,ierror)
   ...
   implicit none
   OMPI_F08_IGNORE_TKR_TYPE, OMPI_ASYNCHRNOUS, INTENT(IN) :: buf
   ...
   call ompi_rsend_init_f(buf,count,datatype%MPI_VAL,dest,tag,comm%MPI_VAL,request%MPI_VAL,c_ierror)
